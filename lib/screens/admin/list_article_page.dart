...
import 'package:trash_track/screens/user/detail_article_page.dart';
...
class _ListArticlePageState extends State<ListArticlePage> {
  ...
  Future<void> deleteArticle(int id) async {
    final supabase = Supabase.instance.client;
    final response = await supabase.from('articles').delete().eq('id', id);
    setState(() {
      _futureArticles = fetchArticles(); // Refresh list
    });
  }
